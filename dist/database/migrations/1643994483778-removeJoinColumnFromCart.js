...
exports.removeJoinColumnFromCart1643994483778 = void 0;
class removeJoinColumnFromCart1643994483778 {
    constructor() {
        this.name = 'removeJoinColumnFromCart1643994483778';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "carts" DROP COLUMN "userId"`);
        });
    }
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "carts" ADD "userId" uuid`);
...
exports.removeJoinColumnFromCart1643994483778 = removeJoinColumnFromCart1643994483778;
